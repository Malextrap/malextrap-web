 ...
 */
function animateLogo(logoQuery) {
...
export default () => {
  animateLogo("header.header > div.title > img")
        ...
        <div className={"container"}>
          <div className={"features columns"}>
            <div className={"features-head"}>
              <h1>
                Framework features <i className={"icons document"} />
              </h1>
            </div>
            ...
            <Feature
              title={
                <p>
                  <a className={"icons-react"}>reac</a>{" "}
                  <span className={"no-margin"}>Reactive components</span>
                </p>
              }
              content={
            ...
            <Feature
              title={
                <p>
                  <i className={"icons-browser-upload"} />{" "}
            ...
            <Feature
              title={
                <p>
                  <i className={"icons-browser"} />{" "}
                  <span>Flexbox & Responsive</span>
                </p>
              }
              content={
